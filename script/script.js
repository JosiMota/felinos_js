...
const nome = prompt("qual  animal voce deseja?")
console.log(nome); 

const animais = document.querySelectorAll('.item')
let foto =""
animais.forEach(element => {

    console.log(element.childNodes);

    if (nome === element.childNodes[1].textContent) {
        foto = prompt('digite caminho da img')
        console.log("animal encontrado");
        console.log(element.childNodes[0].getAttribute("src"))
        element.childNodes[0].setAttribute("src", foto)
    }
}); 
